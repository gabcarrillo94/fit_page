...
nivel personal?  <br> Usa un puntaje del 1 al 10 para cada
una en orden de importancia para ti.  </legend>
            
            <div>
				<div class="row" style="margin-bottom: 4%;margin-top: 3%;">
					<div class="col-md-6 col-xs-12">
						<label style="width:65%" for="qst_3_1">Mejorar tu salud.</label>
						<input style="width:25%;position: absolute;"
					...
					<div class="col-md-6 col-xs-12">
						<label style="width:65%" for="qst_3_2">Mejorar tu resistencia.</label>
						<input style="width:25%;position: absolute;"
                ...
                <div class="row" style="margin-bottom: 2%;">
					<div class="col-md-6 col-xs-12">
						<label style="width:65%" for="qst_3_3">Incrementar masa muscular.</label>
						<input style="width:25%;position: absolute;"
					...
					<div class="col-md-6 col-xs-12">
						<label style="width:65%" for="qst_3_4">Perder grasa.</label>
						<input style="width:25%;position: absolute;"
                ...
                <div class="row" style="margin-bottom: 4%;">
					<div class="col-md-6 col-xs-12">
						<label style="width:65%" for="qst_3_5">Aumentar de peso. </label>
						<input style="width:25%;position: absolute;"
					...
					<div class="col-md-6 col-xs-12">
						<label style="width:65%" for="qst_3_6">Incrementar fuerza. </label>
						<input style="width:25%;position: absolute;"
...
opciones,  <br> ¿Cual escogerías y por qué? </legend>
...
fácil de mantener. ">
                        ...
                        <span>Llegar a tu objetivo lentamente pero de una forma fácil de mantener. </span>
                    </label>
                </div>
            </div>
...
de ejercicios realizas?</legend>
            ...
            @if (Auth::user()->sex == 'F')
				...
				<input id="qst_17" type="date"
					...
					value="{{ old('qst_17') or date('Y-m-d') }}"
					>
			@endif
